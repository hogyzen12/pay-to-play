    ...
    <AnimatePresence>
      ...
      >
        ...
        <List sx={{ padding: '0', mb: '16px' }}>
          ...
          <ListItem>
            <ListItemText>
              ...
              hit). The full position is exited if the price is below 0.70 USDC
              over 3 days.
            </ListItemText>
          </ListItem>
        </List>
        ...
        <Typography sx={styles.regular}>
          ...
          Table solution Solana implements.{' '}
          <Box sx={styles.boldText} component="span">
        ...
        <Typography sx={styles.regular}>
          ...
          <Box sx={styles.boldText} component="span">
            ...
            put - when mutable you can delete or update something - whilst when
            immutable you can&apos;t edit anything, it&apos;s meant to stay
            there forever unaltered.
          </Box>
        </Typography>
        <Typography sx={styles.regular}>
        ...
        <Typography sx={styles.regular}>
          ...
          permanent.{' '}
          <Box sx={styles.boldText} component="span">
            Yes that is burnt which means SHDW will effectively be deflationary
            as it&apos;s usage and the amount of files stored immutably on the
            SHDW drive grows.
          </Box>
        </Typography>
        <Typography sx={styles.regular}>
        ...
        <List sx={{ padding: '0', mb: '24px' }}>
          ...
          <ListItem>
            <ListItemText>
              ...
              - does the chart coincide with the above outlook and is it primed
              for entry? The information divulged above from the GenGo channels
              is not common knowledge, and in general should not be reflected in
              the current price action. The TA will also offer us a take profit
              target, looking to take advantage of momentum in the market as the
              above knowledge regarding staking and burning of SHDW becomes
              public knowledge along with the SHDW drive becoming operational.
            </ListItemText>
          </ListItem>
        </List>
...
export default withMetadata({ title, description })(Alpha);
