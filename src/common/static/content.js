  ...
  pages: {
    home: {
      ...
      howToDescriptionSecond:
        'Click/tap on a square in the crossword grid to toggle the word direction from Across to Down (or vice versa). Click/tap on any clue in the Clue Panel to highlight the corresponding word-space in the grid.',
      selectPayment: 'Select Payment to start game:',
      sol: 'SOL',
      dhmt: 'DHMT',
    },
    main: {
    ...
    crossword: {
      ...
      successModal: {
        ...
        description:
          "The Diamond Hands NFT project is backed by Cryptonary's team of leading industry experts.The Diamond Hands NFT project is backed by Cryptonary's team of leading industry experts.",
        button: 'Got it',
      },
      submitModal: {
        ...
        across: 'Across',
        down: 'Down',
        something: 'Something isnt right?',
        button: 'Submit',
      },
    },
    notFound: {
      message: 'Sorry, this page does not exist',
      redirect: 'You will be redirected to home page in 5 seconds',
    },
  },
  footer: {
