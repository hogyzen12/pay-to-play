    ...
    <AnimatePresence>
      ...
      >
        ...
        <Typography sx={styles.regular}>
          ...
          currently in development; and often overlooked.
        </Typography>
        <Typography sx={styles.regular}>
          ...
          those lines. But what actually are synths? And how can they be used in
          the context of cross-chain communications? Let’s find out!
        </Typography>
        <Typography
          sx={{
            ...styles.regular,
        ...
        <List sx={{ mb: '32px' }}>
          ...
          <ListItem sx={{ padding: '0 0 0 16px' }}>
            <ListItemText sx={styles.italicText}>
              ...
              chains, allowing them to be moved easily between chains since the
              information is shared and validated across multiple chains by a
        ...
        <Typography sx={styles.regular}>
          ...
          sUSD (synthetic USD) is a derivative of USD that is pegged to the
          price of USD. Unlike other forms of pegged assets, like USDT, synths
          are backed by any asset held in reserve and the price of the synthetic
          asset is determined using oracles.
        </Typography>
        ...
        <Typography sx={styles.regular}>
          ...
          (Chainlink) to query the debt across{' '}
        ...
        <Typography sx={styles.regular}>
          ...
          essentially “teleporting” synths between chains.
        </Typography>
        <Typography sx={styles.regular}>
          To simplify, what this means is that going forward Synthetix will know
          exactly how much debt is held on what chain, as well as how many
          synths have been minted on each of those chains. Using this
        ...
        <Typography sx={{ ...styles.regular, mb: '32px' }}>
          What Synthetix is doing is a huge step for cross-chain comms, however
          they are still quite early in development. We don’t expect a fully
        ...
        <Typography sx={styles.regular}>
          ...
          Essentially the information must be valid on both chains,{' '}
        ...
        <Typography sx={styles.regular}>
          ...
          the synthetic assets model so there is the best of both worlds there.
          We expect THOR.Synths to be composable with IBC-chains sometime this
          year.
        </Typography>
        <Typography sx={styles.regular}>
          ...
          important derivatives are, have a read of our DeFi derivatives thesis{' '}
          <Link
            sx={styles.link}
...
export default withMetadata({ title, description })(Teleport);
