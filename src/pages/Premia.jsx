      ...
      <AnimatePresence>
        ...
        >
          ...
          <Typography sx={{ ...styles.regular, mb: '32px' }}>
            ...
            the protocol, giving you an outline of what we{"'"}re excited about,
            any concerns we have, and whether we personally would invest. Then,
            perhaps most importantly, we{"'"}ll cover what we want to see going
            forward - what would make us change our view, or reinforce it and
            see us double down.
          </Typography>
          ...
          <Typography sx={{ ...styles.regular, mb: '32px' }}>
            ...
            when diving deep, but I{"'"}ve discovered masses of alpha on Premia,
            and see no way Dopex could steal the crown.
          </Typography>
          ...
          <List>
            <ListItem sx={{ padding: '0 0 0 16px' }}>
              <ListItemText>
                &#9679;{'  '}vePREMIA is the staked version of PREMIA. vePREMIA
                is locked for a period of time, decided by the staker. The
                longer they lock their PREMIA, the more fees, voting rights and
                other rewards they earn.
              </ListItemText>
            </ListItem>
            <ListItem sx={{ padding: '0 0 0 16px' }}>
              <ListItemText>
                ...
                additional PREMIA rewards. This hopes to inspire a Curve wars
                type situation.
              </ListItemText>
            </ListItem>
            <ListItem sx={{ padding: '0 0 0 16px' }}>
          ...
          <Typography sx={styles.regular}>
            ...
            guess (from conversations with the team) on the very basics of what
            it will involve.
          </Typography>
          <Typography sx={{ ...styles.regular, mb: '32px' }}>
            I don{"'"}t want anyone turning up at my house saying “that{"'"}s
            not how it worked” or “you missed this out”. I will update you guys
            when they have released the details, and include a link here.
          </Typography>
          ...
          <Typography sx={styles.regular}>
            ...
            couple of different versions of staked ETH. The team are working on
            the contracts for this at the moment, and they are expected to be
            ready very soon.
          </Typography>
          <Typography sx={{ ...styles.regular, mb: '32px' }}>
            The user experience will be improved throughout, including a
            dashboard detailing all updates since you last visited the platform
            (tied to your wallet). This is expected in the next few weeks.
          </Typography>
          <Typography sx={{ ...styles.title, mb: '24px' }} variant="h3">
            V3
          </Typography>
          <Typography sx={styles.regular}>
            This is the big daddy of what{"'"}s coming up for Premia. Version 3
            of the platform.
          </Typography>
          ...
          <Typography sx={styles.regular}>
            ...
            done automatically for you), which will allow the DOVs building on
            top of Premia to directly connect with Premia{"'"}s pool liquidity
          ...
          <Typography sx={styles.regular}>
            ...
            arbitrage opportunities. The form the vaults will take is unknown,
            as they have yet to share details, but we are very excited.
            Delta-hedging is an issue we are yet to see addressed in DeFi, and
            we think it{"'"}s a vital part of the puzzle.
          </Typography>
          <Typography sx={styles.regular}>
          ...
          <Typography sx={styles.regular}>
            ...
            put forward proposals, through their governance page, if they{"'"}d
            like to see a specific asset or chain supported! The level of
          ...
          <Typography>
            ...
            as their POOL (Protocol Owned Options Liquidity) can form part of
            the protocol{"'"}s treasury management, without them having to pay
            the fees that other vaults charge for the service.
          </Typography>
          ...
          <Typography sx={styles.regular}>
            ...
            find demand to put it to use. Premia has kept relatively stable, but
            I couldn{"'"}t see how they were going to attract more liquidity,
            which will be needed when buyer demand comes knocking.
          </Typography>
          <Typography sx={styles.regular}>
            That was until I dug into V3 vaults, and found out they were funding
            not 1, but 2 DOV/structured product protocols, both building
            directly on top of Premia!
          </Typography>
          <Typography
            sx={{
              ...styles.regular,
          ...
          <Typography sx={styles.regular}>
            ...
            protocol, similar to traditional DOVs such as Ribbon and Friktion.
            We expect to see the first version of Fort Knox Vaults live in
            around 2 months, and as far as I{"'"}m aware, it will be the 1st DOV
            protocol on Arbitrum.
          </Typography>
          <Typography sx={styles.regular}>
            Fort Knox Vaults will also distribute 20% of revenue back to Premia
            treasury (and there is discussion of having this go directly to
            PREMIA stakers).
          </Typography>
          <Typography
            sx={{
          ...
          <Typography sx={styles.regular}>
            ...
            and fully expect them to utilise Premia when V3 is released.
            However, we have yet to see Premia{"'"}s unique options pricing
            model used on a large scale, or with DOVs involved.
          </Typography>
          <Typography sx={styles.regular}>
            ...
            other protocols the green light to build atop Premia, and could open
            the flood gates.
          </Typography>
          <Typography sx={styles.regular}>
          ...
          <Typography sx={{ ...styles.regular, mb: '32px' }}>
            ...
            confident they will iterate and address them, but this is something
          ...
          <Typography sx={{ ...styles.regular, mb: '32px' }}>
            ...
            integrations, gas optimizations resulting from new EVM features, and
            other unforeseen opportunities are all on the table. The upgrade
            process will be subject to extensive audit and approval by the
            Premia DAO.”
          </Typography>
          <Typography sx={styles.title} variant="h3">
          ...
          <Typography sx={styles.regular}>
            ...
            capital back so they can keep earning with it. A massive selling
            point vs Hegic, as if your options expire on Hegic without you
            exercising them, you lose any potential gains!
          </Typography>
          <Typography
            sx={{
              ...styles.regular,
          ...
          <Typography sx={styles.regular}>
            ...
            utilisation as that benefits LPs (as the capital is used
          ...
          <Typography sx={styles.regular}>
            ...
            keep a close eye on how it affects supply and demand on the
            protocol. For example, one thing we will be looking at is where pool
            utilisation naturally settles (the point at which buyers and sellers
            are matched). If that happens to be around 70% (for argument{"'"}s
            sake), how would that affect LPs capital efficiency? Is Premia a
            better option than competitors for LP returns? Are buyers happy with
            price at this level? That all needs to be taken into account.
          </Typography>
          <Typography sx={{ ...styles.regular, mb: '32px' }}>
          ...
          <Typography sx={{ ...styles.regular, mb: '32px' }}>
            ...
            keeping an eye out for. If this doesn{"'"}t happen, we{"'"}ll
            consider what implications this could have closer to the time, and
            potentially hedge against potential downside should there be selling
            pressure.
          </Typography>
          <Typography sx={{ ...styles.title, lineHeight: '32px' }} variant="h3">
          ...
          <Typography sx={styles.regular}>
            ...
            year. The tokens will be released over more than 10 years, so we won
          ...
          <Typography sx={styles.regular}>
            ...
            to worry about what these will be used for; the community will vote
            on that. But perhaps there will be a proposal soon to burn some of
            that supply? 👀
          </Typography>
          <Typography sx={styles.regular}>
          ...
          <List sx={{ mb: '32px' }}>
            <ListItem sx={{ padding: '0 0 0 16px' }}>
              <ListItemText>
                ...
                generate some serious hype to match the impressive offering
                Premia is crafting. We{"'"}d like to see V3 hit the ground
                running, and Premia grow consistently from there.
              </ListItemText>
            </ListItem>
            <ListItem sx={{ padding: '0 0 0 16px' }}>
              <ListItemText>
          ...
          <Typography sx={{ ...styles.regular, mb: '32px' }}>
            ...
            due to BT{"'"}s recent run (from 37k up to 48k) but is now testing
            the $2.10 resistance level. The closest support is around $1, which
            can be considered a huge demand area for PREMIA. If PREMIA manages
            to break its previous high ($2.5) by a daily closure above it, then
            we would be looking at a possible reversal in market structure, from
            bearish to bullish. If that happens, then the next resistance area
            to look out for is around $3.5. Volume has been average for now, we
            want to see a strong break out above the $2.5 resistance, backed by
            high buying volume.
          </Typography>
          <Typography sx={styles.title} variant="h3">
            Conclusion
          ...
          <Typography sx={styles.regular}>
            ...
            {"'"}t priced them in yet in my opinion. Premia is relatively under
            the radar at the moment, and I believe vePREMIA, DOV integration
            (and open-sourcing code for future integrations) and V3 are a
            superpowered catalyst. Should these changes be successfully
            implemented, PREMIA is primed and loaded for a stratospheric run.
          </Typography>
        </Box>
      </AnimatePresence>
    </AppContainer>
