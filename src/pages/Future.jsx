    ...
    <AnimatePresence>
      ...
      >
        ...
        <Typography sx={styles.regular}>
          The Babylonian dynasty King Hammurabi is not someone we mention often
          at Cryptonary.
        </Typography>
        <Typography sx={styles.regular}>
        ...
        <Typography sx={styles.regular}>
          ...
          now traded more than anything else in the field, capturing 62% of the
          crypto volume in January 2022.
        </Typography>
        <Typography
          sx={{
            ...styles.regular,
        ...
        >
          <ListItem sx={styles.listItem}>
            <ListItemText>
              &#9679;{'  '}Futures contracts are agreements to trade an asset at
              an upcoming time, for a specific price.
            </ListItemText>
          </ListItem>
          <ListItem sx={styles.listItem}>
            <ListItemText>
          ...
          <ListItem sx={styles.listItem}>
            <ListItemText>
              ...
              centralised counterparts in terms of user experience and what they
              offer.
            </ListItemText>
          </ListItem>
          <ListItem sx={styles.listItem}>
        ...
        <Typography sx={styles.regular}>
          ...
          at a specific point in the future, for a predetermined price.
        </Typography>
        ...
        >
          ...
          modern format allow users to trade with huge leverage (get rekt). More
          on these later in the report.
        </Typography>
        <Typography sx={styles.title} variant="h3">
          Back to the Futures
        </Typography>
        <Typography sx={styles.regular}>
          ...
          codes. It allowed sales of goods and assets to be delivered for an
          agreed price at a future date, requiring contracts and witnesses.
        </Typography>
        <Typography sx={styles.regular}>
        ...
        <Typography sx={styles.regular}>
          ...
          Merchantile Exchange (CME) to purchase dated crypto futures. For us
          native crypto folk, there is something else on offer.
        </Typography>
        <Typography
          sx={{
            ...styles.regular,
        ...
        >
          ...
          (settlement date) in crypto, the big dogs in crypto are perpetual
          futures (perps), also known as perpetual swaps. The opportunity to
          leverage and win big with these has drawn in traders for years, many
          of them ending up REKT.
        </Typography>
        <CardMedia
          sx={{ mb: '24px' }}
        ...
        <Typography sx={styles.regular}>
          ...
          perps in September and October 2019 respectively, with dYdX launching
          them in May 2020.
        </Typography>
        <Typography sx={styles.regular}>
        ...
        <Typography sx={styles.regular}>
          ...
          exposure is virtually the same. The reason people use perps rather
          than holding spot positions is simple: leverage (and the ability to
          short). The majority of perp venues offer leverage up to 100x, meaning
          you can put down $10, and have exposure to $1,000 of the underlying
          asset.
        </Typography>
        <Typography sx={styles.regular}>
        ...
        <Typography sx={{ ...styles.regular, ...styles.italicText }}>
          ...
          position or positions will be liquidated, meaning you lose everything.
        </Typography>
        <Typography sx={styles.regular}>
        ...
        <Typography sx={styles.regular}>
          ...
          positions being liquidated, which increases sell pressure, driving the
          price down, resulting in more liquidations… it’s a vicious cycle.
        </Typography>
        <Typography
          sx={{
            ...styles.regular,
        ...
        <Typography sx={styles.regular}>
          ...
          asset, involving regular payments between buyers and sellers (often
          every 8 hours, although it can vary, with dYdX, FTX and Perpetual
          Protocol conducting payments every hour).
        </Typography>
        <Typography sx={styles.regular}>
          ...
          selling, bringing down the price to fall in line with the underlying.
        </Typography>
        <CardMedia
          sx={{ mb: '24px' }}
        ...
        <Typography sx={styles.regular}>
          ...
          buying and disincentivising selling, raising the perp price to fall in
        ...
        <Typography sx={styles.regular}>
          ...
          notional position, so if you put down $10 using 100x leverage, you
          will be charged a percentage of the $1,000 notional position.
        </Typography>
        <Typography sx={styles.title} variant="h3">
        ...
        />
        <Typography sx={styles.regular}>
          DYDX (THE ONLY DEFI FUTURES VENUE MEASURED ON COINGLASS) IS THE LIGHT
          PINK
        </Typography>
        <Typography sx={styles.regular}>
        ...
        <Typography sx={styles.regular}>
          ...
          users, with DeFi offering full decentralisation and censorship
        ...
        <Typography sx={styles.regular}>
          ...
          innovation is happening at breakneck speed; we are seeing the negative
          trade-off turning on its head. Layer 2 solutions like StarkWare and
          Gnosis (formerly known as xDai) are enabling gas-free trading.
          Improved UI/UXs make it just as intuitive to trade on the
        ...
        <Typography sx={{ ...styles.regular, ...styles.italicText }}>
          ...
          ones that stood out in research. This doesn’t take into account vital
          information such as tokenomics. If we see an opportunity for our
          investment, we will write a standalone report with further
          information.
        </Typography>
        <Typography
          sx={{
        ...
        <Typography sx={styles.regular}>
          ...
          style, and has repeatedly overtaken Coinbase in daily trading volumes
          as a result. As the only perp exchange utilising ZK roll-ups (viewed
          by many, including Vitalik, as the future of Ethereum scaling), and
          with a hall-of-fame list of backers including Andreessen Horowitz,
          a16z and Paradigm, you can’t ignore dYdX. The protocol is currently
          sitting head and shoulders above the rest of the market. The question
          is: can it stay there?
        </Typography>
        <CardMedia
          sx={{ mb: '24px' }}
        ...
        <Typography sx={styles.regular}>
          Whilst Perpetual Protocol has suffered from dYdX’s rise, its downturn
          was inevitable given its shortcomings. Despite this it has managed to
          retain stable trading volume, solving many of those shortcomings with
          its latest update, Curie.
        </Typography>
        <CardMedia
          sx={{ mb: '24px' }}
        ...
        <Typography sx={styles.regular}>
          ...
          facilitating ways for future projects to build on top of them, such as
          a grant scheme.
        </Typography>
        <Typography sx={styles.regular}>
          dYdX, meanwhile, is laser-focused on performance without comprising
          decentralisation, trading off collaboration and composability. Powered
          by Starkware’s StarkEx platform, dYdX is an app-specific roll-up (all
          code is customised to the needs of dYdX), meaning it is not a platform
          where multiple DeFi legos can stack up.
        </Typography>
        <Typography
          sx={{
            ...styles.regular,
        ...
        <Typography sx={styles.regular}>
          ...
          two-click community listings. For the latter, anyone can list any pair
          with a single asset in two clicks.
        </Typography>
        <Typography sx={styles.regular}>
          ...
          impressive backers including Pantera, ByBit, and Wintermute, along
          with its range of unique offerings and impressive growth - hitting
          $3bn trading volume in Jan 2022 - make it one to watch.
        </Typography>
        <CardMedia
          sx={{ mb: '24px' }}
        ...
        <Typography sx={styles.regular}>
          ...
          2022, they plan to offer power perpetuals and everlasting options: two
        ...
        >
          ...
          before it can realise its full potential in DeFi, but the protocols
          being created on the blockchain are impressive.
        </Typography>
        <Typography sx={styles.title} variant="h3">
          Conclusion
        </Typography>
        <Typography sx={styles.regular}>
          Decentralised perp daily volume typically hovers around $5bn: under 1%
          of overall crypto derivatives volume. With regulatory pressures,
        ...
        <Typography sx={styles.regular}>
          ...
          people use DeFi it gains more credibility, causing more people to
        ...
        <Typography sx={styles.regular}>
          ...
          believe will be especially prevalent in futures trading, is going to
          be this migration from CeFi to DeFi.
        </Typography>
        <Typography sx={{ ...styles.regular, ...styles.italicText }}>
...
export default withMetadata({ title, description })(Future);
