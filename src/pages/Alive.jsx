    ...
    <AnimatePresence>
      ...
      >
        ...
        <Typography sx={styles.regular}>
          ...
          cases, capabilities, limitations, and offering.
        </Typography>
        <Typography sx={styles.regular}>
          Rather, the question now is very simple - how can we enhance
          cooperation between these chains and integrate them into a functional
          economic system that can rival that of the TradFi world?
        </Typography>
        <Typography sx={styles.regular}>
          It is one of the most pressing problems that is stunting the growth of
          the market, and the adoption of blockchain technology on a global
          scale. The issue affects everything from user experience, to
          innovation, and there is no solution that has been universally adopted
        ...
        >
          &nbsp; Disclaimer: This is not investment nor investment advice. Only
          you are responsible for any capital-related decisions you make and
        ...
        >
          ...
          <ListItem sx={{ padding: '0 0 0 16px' }}>
            <ListItemText>
              &#9679;{'  '}Scaling the solution and improving user experience is
              the next phase for the liquidity pool model of cross-chain
              communications.
            </ListItemText>
          </ListItem>
        </List>
        ...
        <Typography sx={styles.regular}>
          ...
          will carry out in their day-to-day business.
        </Typography>
        ...
        <Typography sx={styles.regular}>
          ...
          the exchange and the whole process remains trustless, permissionless,
        ...
        <Typography sx={{ ...styles.regular, mb: '32px' }}>
          ...
          standards. Want to swap some ERC-20 USDC for ETH? Great! SushiSwap can
          facilitate that. Want to swap BNB for ETH? Errr - you’ll have to look
          elsewhere.
        </Typography>
        <Typography sx={styles.title} variant="h3">
        ...
        <Typography sx={styles.regular}>
          But how is this possible, you ask? I thought you said there was no way
          for transactions to be recorded across chains?
        </Typography>
        <Typography sx={styles.regular}>
          Remember the AMM method that we outlined above, where Liquidity Pools
          are used to facilitate trustless transactions? That’s exactly how
          THORChain works, but with a couple of extra steps:
        </Typography>
        <List>
          <ListItem sx={{ padding: '0 0 0 16px' }}>
            <ListItemText>
        ...
        <List sx={{ mb: '32px' }}>
          <ListItem sx={{ padding: '0 0 0 16px' }}>
            <ListItemText>
              &#9679;{'  '}RUNE is the second asset that must be deposited when
              a Liquidity Provider adds liquidity to one of the pools.
            </ListItemText>
          </ListItem>
          <ListItem sx={{ padding: '0 0 0 16px' }}>
            <ListItemText>
          ...
          <ListItem sx={{ padding: '0 0 0 16px' }}>
            <ListItemText>
              &#9679;{'  '}When a swap occurs, the users 1 BTC is deposited into
              the BTC pool, and 1,000 RUNE is sent from the BTC pool to the ETH
              pool - remember, the pool must always be balanced.
            </ListItemText>
          </ListItem>
          <ListItem sx={{ padding: '0 0 0 16px' }}>
            <ListItemText>
              &#9679;{'  '} Now the RUNE/ETH pool has a surplus of 1000 RUNE -
              how much ETH does it need to move to get back to equilibrium? If 1
              ETH = 100 RUNE, then 10 ETH must be withdrawn from the pool to
        ...
        <List>
          <ListItem sx={{ padding: '0 0 0 16px' }}>
            <ListItemText sx={styles.italicText}>
              &#9679;{'  '} Instead of a centralised broker handling trades, we
              have Automated Market Makers.
            </ListItemText>
          </ListItem>
          <ListItem sx={{ padding: '0 0 0 16px' }}>
            <ListItemText sx={styles.italicText}>
        ...
        <Typography sx={styles.regular}>
          ...
          any asset on any DEX can be traded using{' '}
          <Typography sx={styles.italicText} component="span">
            any other
          </Typography>{' '}
        ...
        <Typography sx={styles.regular}>
          ...
          for most individuals. However, the growing adoption and acceptance of
          cryptocurrencies have opened a lot of doors for DeFi protocols that
          would have been impossible just a year or two ago. The future is
          bright…{' '}
          <Typography sx={styles.boldText} component="span">
...
export default withMetadata({ title, description })(Alive);
