      ...
      <AnimatePresence>
        ...
        >
          ...
          <Typography sx={{ mb: '32px' }}>
            ...
            you logically see why Layer-1s such as Solana and Terra really
            boomed in 2021. What&apos;s next?
          </Typography>
          <Typography sx={styles.title} variant="h3">
            Sector Hype | 2022
          </Typography>
          <Typography>
            ...
            sectors are due for outperformance given the natural state of growth
            of this market. In other words, they are the solution to the most
            prominent problems faced today{' '}
            <Box sx={styles.italicText} component="span">
          ...
          <List component="ol">
            <ListItem>
              <ListItemText>
                ...
                continuing to rise but we don&apos;t think it would be as easy
                as last year, mainly because of this next sector.
              </ListItemText>
            </ListItem>
            <ListItem>
              <ListItemText>
                ...
                London. This is where Layer-2s come into play with better UX and
                significantly lower fees. With exchanges opening up withdrawals
                directly to L2s such as FTX/Binance with Arbitrum and mobile
                wallets doing 100x improvements with zkSync (try{' '}
                <Link
                  sx={styles.link}
            ...
            <ListItem>
              <ListItemText>
                ...
                complex products to hedge/limit their risk and we shouldn{"'"}t
                stop them. Derivatives are the most traded products worldwide
          ...
          <Typography sx={{ mb: '32px' }}>
            There are quite a few options out there but the ones that stand out
            to us are: MetaMask. Phantom, Argent & XDeFi.
          </Typography>
          <Typography sx={styles.title} variant="h3">
            The Two Pumps
          </Typography>
          ...
          <Typography sx={{ mb: '32px' }}>
            ...
            2017 and ran up by a massive 150,000%+ simply because it was “new”
            and smart contracts seemed “cool” - basically flavour of the day. At
            the time though, nothing fundamentally backed that pump since there
            was nothing built on top of it except for ERC tokens (no dApps, no
            TVL). Then in 2020, a new pump began but that was after many dApps
            began building and setting up shop on Ethereum, with rising TVL,
            that was the start of ETH&apos;s Fundamental Pump.
          </Typography>
          <Typography sx={styles.title} variant="h3">
          ...
          <Typography sx={{ mb: '32px' }}>
            ...
            crypto would pump in 2022 - as if it was a given. Well let me
            clarify that it is not a given and the year will heavily depend on
            what the FED decides in March about Quantitative Tightening. If they
            do go ahead with it, markets would dump more which means more pain
            but also more undervaluations for fundamentally-sound assets but
            also a pump-delay. If they don&apos;t, and even better print, then
            game on for 2022. For a full breakdown of the FED situation, read{' '}
            <Link
              sx={styles.link}
