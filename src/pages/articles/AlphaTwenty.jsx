...
const AlphaTwenty = ({ styles }) => (
  <>
    ...
    <Typography sx={styles.regular}>
      Friktion has an airdrop coming up, when they release their token. We have
      solid ideas around how we can qualify for this. Getting involved in Volts
      (their structured products), using Entropy, and owning a Lightning OG NFT
      are all involved.
    </Typography>
    <Link
    ...
    <Typography sx={{ ...styles.regular, mb: '32px' }}>
      Use Phantom wallets to qualify for Friktion airdrop by using the platform,
      buying the NFT and testing Entropy exchange. I propose a 7 SOL limit on
      the purchase price of each Lightning OG NFT (was 5, 7 due to price action
      recently).
    </Typography>
    ...
    <Typography sx={{ ...styles.regular, mb: '32px' }}>
      ...
      preferred. I would ideally like to use 5 Phantom wallets for the airdrop
      farming, although I’m not sure of the logistical set up of the Alpha DAO
      wallets.
    </Typography>
    ...
    >
      <ListItem sx={styles.listItem}>
        <ListItemText>&#9679;{'  '}Load each wallet with 10 SOL</ListItemText>
      </ListItem>
      <ListItem sx={styles.listItem}>
        <ListItemText>
      ...
      <ListItem sx={styles.listItem}>
        <ListItemText>
          &#9679;{'  '}Swap 0.25 SOL to USDC and use this to play around with
          Entropy exchange.
        </ListItemText>
      </ListItem>
      <ListItem sx={styles.listItem}>
        <ListItemText>
          &#9679;{'  '}This is not a necessary steps but a nice add on as it may
          be a multiplying factor.
        </ListItemText>
      </ListItem>
      <ListItem sx={styles.listItem}>
        <ListItemText>
      ...
      <ListItem sx={styles.listItem}>
        <ListItemText>
          &#9679;{'  '}Use the remaining SOL in the SOL call option Volt (low
          voltage, meaning low risk).
        </ListItemText>
      </ListItem>
      <ListItem sx={styles.listItem}>
        <ListItemText>
    ...
    <Typography sx={styles.regular}>
      {' '}
      Either way, for the NFTs I propose selling 40% at a 2x, and holding the
      remaining 60% with a view of evaluating their position when more is known
      about the airdrop.
    </Typography>
    <Typography sx={{ ...styles.regular, mb: '32px' }}>
      For the Volt positions, I propose we leave the funds in there until we
      hear more about the airdrop, potentially moving them around depending on
      market movements and Volt performance, but I will keep an eye on this.
    </Typography>
    ...
    >
      <ListItem sx={styles.listItem}>
        <ListItemText>&#9679;{'  '}Swapped 3,500 USDC for ~50 SOL</ListItemText>
      </ListItem>
      <ListItem sx={styles.listItem}>
        <ListItemText>
          &#9679;{'  '}Kept 10 SOL in main wallet and sent 40 SOL to 4 wallets
        </ListItemText>
      </ListItem>
    </List>
    ...
    >
      <ListItem sx={styles.listItem}>
        <ListItemText>
          &#9679;{'  '}Bought <b>1 Lightning OG NFT</b> from each wallet (Total
          Paid: 34.88 SOL)
        </ListItemText>
      </ListItem>
      <ListItem sx={styles.listItem}>
        <ListItemText>
          &#9679;{'  '}Swapped 0.25 SOL to USDC in each address and used Entropy
          Markets (1 BTC-PERP Trade)
        </ListItemText>
      </ListItem>
      <ListItem sx={styles.listItem}>
        <ListItemText>
          &#9679;{'  '}Put 0.3 SOL from each address in the SOL call option Volt
        </ListItemText>
      </ListItem>
      <ListItem sx={styles.listItem}>
        <ListItemText>
          &#9679;{'  '}Swapped 2.4 SOL to USDC in each address and used 0.8 SOL
          in 3 strategies (Volts 2, 3, 4)
        </ListItemText>
      </ListItem>
    </List>
  </>
...
export default withPresence({ title, description })(AlphaTwenty);
